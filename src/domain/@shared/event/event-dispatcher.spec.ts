...
import CustomerAddressChangedEventHandler from "../../customer/event/handler/customer-address-changed-event.handler";
import CustomerCreatedEvent1Handler from "../../customer/event/handler/customer-created-event_1.handler";
import CustomerCreatedEvent2Handler from "../../customer/event/handler/customer-created-event_2.handler";
